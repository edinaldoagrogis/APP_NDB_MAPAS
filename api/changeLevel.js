...
export default async function handler(req, res) {
    ...
    try {
        ...
        return res.status(200).json({ success: true, message: `Nível de ${userData.name} alterado com sucesso.` });
    } catch (e) {
        console.error(e);
        return res.status(500).json({ error: 'Erro interno ao alterar nível do usuário.' });
    }
}
